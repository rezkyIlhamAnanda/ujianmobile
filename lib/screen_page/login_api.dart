...
import 'package:ujianmobile/model/model_login.dart';
import 'package:ujianmobile/screen_page/list_berita.dart';
import 'package:ujianmobile/screen_page/register_api.dart';
import 'package:ujianmobile/utils/session_manager.dart';
...
class _LoginApiState extends State<LoginApi> {
  ...
  Future<ModelLogin?> loginAccount() async{
    ...
    try{
      ...
      http.Response response = await http.post(Uri.parse('http://192.168.100.12/uts_mobile/login.php'),
          body: {
